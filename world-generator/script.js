...
function renderLayer(identifier, count, layerIndex){
  ...
  layer.appendChild(countInput);
    ...
    buttons.innerHTML = ' <img src="https://cdn.glitch.com/17ff8eee-9239-4ba0-8a5c-9263261550b5%2Fcopy.png?v=1617471081488" class="minibutton" onclick="duplicateLayer('+layerIndex+')"> <img src="https://cdn.glitch.com/17ff8eee-9239-4ba0-8a5c-9263261550b5%2Ficon_trash.png?v=1616555108211" class="minibutton" onclick="deleteLayer('+layerIndex+')"> <img src="https://cdn.glitch.com/17ff8eee-9239-4ba0-8a5c-9263261550b5%2Farrow_down_small.png?v=1616861430478" onclick="moveLayer('+layerIndex+', 1)" style="-webkit-transform: scaleY(-1); transform: scaleY(-1);" class="minibutton"> <img src="https://cdn.glitch.com/17ff8eee-9239-4ba0-8a5c-9263261550b5%2Farrow_down_small.png?v=1616861430478" onclick="moveLayer('+layerIndex+', -1)" class="minibutton">';
